...
### A Confession from a Modeling and V&V Veteran
...
I am building both right now, and neither is finished. That is where this series goes next. In the coming parts I will open the hood on how the library was built and validated, what the skills actually contain, and what the process and the tool chain behind it look like as they mature.
